...
export const PROFILES: Profile[] = [
  {
    ...
    description:
      "Disables Game DVR, background apps, telemetry and Cortana — everything that competes with your GPU and CPU during gameplay. Adds MMCSS scheduling, foreground-priority boost, HAGS, safe network-latency tweaks, full Game Bar shutdown and a tighter input pipeline.",
    gradient: "bolt",
    tweakIds: [
      "game-dvr-off",
      "background-apps-off",
      "mouse-accel-off",
      "mouse-hover-time-fast",
      "keyboard-delay-fast",
      "keyboard-speed-fast",
      "usb-selective-suspend-off-global",
      "hid-power-management-off",
      "telemetry-off",
      "cortana-off",
      ...
      "tcp-ack-and-no-delay",
      "tcp-delack-ticks-off",
      "qos-reserved-bandwidth-off",
      "hags-on",
      "gpu-tdr-delay-extend",
      "nvidia-telemetry-services-off",
      "power-throttling-off-policy",
      "processor-perf-boost-aggressive",
      "fullscreen-optimizations-off-global",
      "game-bar-fully-off",
      "xbox-game-monitoring-off",
      "game-bar-presence-writer-off",
      "ntfs-8dot3-off",
      "dwm-input-io-completion-on",
    ],
  },
  {
    id: "gaming-esports",
    name: "Gaming · Esports",
    tagline: "Lowest latency at all cost",
    description:
      "Everything from the Gaming profile plus the aggressive latency tweaks: NIC interrupt moderation off, EEE/flow-control off, AFD socket buffers enlarged, core parking disabled, HPET off, TSC sync Enhanced. Higher power draw and CPU load — meant for plugged-in desktop rigs where competitive ping matters.",
    gradient: "bolt",
    tweakIds: [
      "game-dvr-off",
      "background-apps-off",
      ...
      "tcp-delack-ticks-off",
      "qos-reserved-bandwidth-off",
      "nic-energy-efficient-ethernet-off",
      "nic-flow-control-off",
      "nic-interrupt-moderation-off",
      "afd-receive-window-tune",
      "hags-on",
      "gpu-tdr-delay-extend",
      "nvidia-telemetry-services-off",
      "amd-ueip-off",
      "power-throttling-off-policy",
      "bcdedit-tscsync-enhanced",
      "core-parking-off-ac",
      "processor-perf-boost-aggressive",
      "fullscreen-optimizations-off-global",
      "game-bar-fully-off",
