...
**v0.17.0.** Phases 1-5 shipped, Phase 6 partially shipped, Phase 7-14 shipped, Phase 15 (Catalog depth + mass driver updates) shipped. For a per-version diff see [`CHANGELOG.md`](CHANGELOG.md); for what's left before v1.0.0 see [`docs/ROADMAP.md`](docs/ROADMAP.md). Post-v1.0 ideas in [`docs/PLAN.md`](docs/PLAN.md).
